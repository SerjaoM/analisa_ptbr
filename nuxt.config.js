...
const baseUrl = ( // eslint-disable-next-line no-undef
  process.env.BASE_URL || "https://www.gvb.tec.br"
).replace("http:", "https:");
...
export default {
  ...
  firebase: {
    config: {
      apiKey: "AIzaSyB4_bn7GJrvLJDhBbxXz6zBr4gAiohRzTM", //fireadm_3lm
      authDomain: "groupsanalyctis.firebaseapp.com",
      projectId: "groupsanalyctis",
      storageBucket: "groupsanalyctis.appspot.com",
      messagingSenderId: "279262363179",
      appId: "1:279262363179:web:e094832a9880526969b46e",
      measurementId: "G-4ZYLMKF3DM",
    },
    services: {
  ...
  gtm: {
    id: "GTM-W32PNH3", // tag de conversao do google
  },
  sentry: {
    dsn:
      "https://2a0d7fd7e36b4ed32032816425991691@o4506705622335488.ingest.sentry.io/4506705649795072", //driveserjao
    disabled: local,
    ...
    webpackConfig: {
      include: ["./dist/"],
      ignore: ["node_modules"],
      org: "gvb-l4", // nome da organização no SENTRY drive serjao
      project: "javascript-nextjs-zapz",  // nome do projeto no SENTRY drive serjao
    },
  },
